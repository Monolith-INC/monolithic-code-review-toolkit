---
name: review-task
description: Use when a small unit of work is complete, before committing or handing off, to check the changes actually introduced against that task's requirements and goals and report any discrepancies. Optional flags: --lenses maintainability|typescript|all.
---
